...
<body>
    ...
    <main class="content">
        <div style="display:flex; justify-content:space-between; max-width:800px; margin: 0 auto 1rem;">
            <a href="index.php" class="btn btn-secondary back-btn"><i class="fa-solid fa-arrow-left"></i> Back</a>
            <button onclick="window.print()" class="btn btn-primary print-btn"><i class="fa-solid fa-print"></i> Print / Save PDF</button>
        </div>
        ...
        <div class="invoice-document">
            <div class="invoice-header">
                ...
                <div class="company-details">
                    <div class="company-name">Your Company LLC</div>
            ...
            <div class="billing-grid">
                ...
                <div class="billing-box" style="text-align: right;">
                    <h3>Details</h3>
                    <p><strong>Issue Date:</strong> <?= date('F d, Y', strtotime($invoice['issue_date'])) ?></p>
            ...
            <div style="display: flex; justify-content: flex-end; margin-bottom: 3rem;">
                <div style="width: 300px;">
                    <div style="display:flex; justify-content:space-between; padding: 1rem 0; font-size: 1.25rem; font-weight: 700; border-top: 2px solid var(--border);">
                        <span>Total Due</span>
                        <span style="color: var(--primary);">$<?= number_format($invoice['total_amount'], 2) ?></span>
                    </div>
                </div>
            </div>
            ...
            <div style="background: var(--background); padding: 1.5rem; border-radius: 0.5rem;">
                <h3 style="font-size: 0.875rem; color: var(--text-muted); margin-bottom: 0.5rem; text-transform:uppercase;">Notes</h3>
